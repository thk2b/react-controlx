...
var _createModel2 = require('xcontrol/lib/models/createModel');
...
exports.default = function (Component) {
    return function (_createModel) {
        _inherits(ComponentController, _createModel);

        function ComponentController(selectedProps) {
            ...
            // )
            var _this = _possibleConstructorReturn(this, (ComponentController.__proto__ || Object.getPrototypeOf(ComponentController)).call(this, selectedProps));
    ...
    }((0, _createModel3.default)(_react2.default.Component));
};
